...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlc_mlops_stacks_aws/terraform``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlc_mlops_stacks_aws/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlc_mlops_stacks_aws/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlc_mlops_stacks_aws-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-mlc_mlops_stacks_aws-model", "Model Name")
