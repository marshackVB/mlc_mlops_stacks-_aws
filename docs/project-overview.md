...
```
mlc_mlops_stacks_aws         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlc_mlops_stacks_aws       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
