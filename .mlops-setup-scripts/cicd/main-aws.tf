module "aws_create_sp" {
  ...
  service_principal_name       = "mlc_mlops_stacks_aws-cicd"
  project_directory_path       = "/mlc_mlops_stacks_aws"
  service_principal_group_name = "mlc_mlops_stacks_aws-service-principals"
}
